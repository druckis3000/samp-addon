...
#pragma pack( 1 )
	...
	void				*actor; /* 252 (struct actor_info) - pointer to Actor Object is attached to, 0 when not attached */
...
#pragma pack( 1 )
	...
	*/
	...
	char				pedIK[32];	/* 1292 - Inverse Kinematics */
...
struct vehicle_info
{
	...
	void						*pHandlingData;		/* 900 */ // type: tHandlingDataSA
	void						*pFlyData;			/* 904 */ // type: struct physicalFlyParams
	...
	char						m_nVehicleFlagsOffset[8]; /* 1064 */
	...
	DWORD				m_trainFlags;				/* 1464 */ // type: CTrainFlags
	...
	uint8_t				__unknown_2032[180];	/* 2032 */
	float				fNitroCount;			/* 2212 */
